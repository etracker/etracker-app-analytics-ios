...
/**
 * Adds a prefix to the internal lib_version string. Can be used if the library is embedded
 * in a framework like, e.g., Flutter.
 */
@property (copy) NSString *libVersionPrefix;
